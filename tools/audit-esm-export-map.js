...
expectSliceExcludes(
  "src/game.js",
  "target stick helper alias slice",
  "function moveTargetStick",
...
expectSliceExcludes(
  "src/game.js",
  "opponent target helper alias slice",
  "function opponentHeadTarget",
  "function keyboardAttackUsesDirection",
  ["HexSnakeState.", "HexSnakeUI."]
);

expectSliceExcludes(
  "src/game.js",
  "keyboard attack direction helper alias slice",
  "function keyboardAttackUsesDirection",
  "function targetModeCrosshairSvg",
  ["HexSnakeState.", "HexSnakeUI."]
);

expectSliceExcludes(
  "src/game.js",
  "keyboard attack hint helper alias slice",
  "function showKeyboardAttackHint",
...
expectSliceExcludes(
  "src/game.js",
  "player direct attack helper alias slice",
  "function playerDirectAttackTarget",
  "function playerAttackFailureReason",
  ["HexSnakeState.", "HexSnakeUI."]
);

expectSliceExcludes(
  "src/game.js",
  "player attack failure helper alias slice",
  "function playerAttackFailureReason",
...
expectSliceExcludes(
  "src/game.js",
  "launch player attack helper alias slice",
  "function launchPlayerAttack",
  "function launchPlayerAttackDirection",
  ["HexSnakeState.", "HexSnakeUI."]
);

expectSliceExcludes(
  "src/game.js",
  "launch player attack direction helper alias slice",
  "function launchPlayerAttackDirection",
...
expectSliceExcludes(
  "src/game.js",
  "perform module attack helper alias slice",
  "function performModuleAttack",
...
expectSliceExcludes(
  "src/game.js",
  "clear module hold helper alias slice",
  "function clearModuleHold",
...
expectSliceExcludes(
  "src/game.js",
  "toggle pause helper alias slice",
  "function togglePause",
...
expectSliceExcludes(
  "src/game.js",
  "surrender game helper alias slice",
  "function surrenderGame",
  "function boardCellFromPointer",
  ["HexSnakeState.", "HexSnakeUI."]
);

expectSliceExcludes(
  "src/game.js",
  "board attack pointer helper alias slice",
  "function boardCellFromPointer",
...
expectSliceExcludes(
  "src/game.js",
  "settings panel helper alias slice",
  "function currentSettingsPage",
  "let settingsPageSwipe",
  ["HexSnakeState.", "HexSnakeUI."]
);
...
expectSliceExcludes(
  "src/game.js",
  "attack button pointer / keyboard aim button alias slice",
  "function defaultPlayerAttackTarget",
...
expectSliceExcludes(
  "src/game.js",
  "rules / tutorial launcher alias slice",
  "Dom.rulesButton.addEventListener",
...
expectSliceExcludes(
  "src/game.js",
  "intro / tutorial interaction alias slice",
  "Dom.introCloseButton.addEventListener",
...
expectSliceExcludes(
  "src/game.js",
  "start button alias slice",
  "Dom.startButton.addEventListener",
  "Dom.computerBattleButton.addEventListener",
  ["HexSnakeState.", "HexSnakeUI."]
);

expectSliceExcludes(
  "src/game.js",
  "computer battle button alias slice",
  "Dom.computerBattleButton.addEventListener",
  "function applyAutoBattleSpeedIndex",
  ["HexSnakeState.", "HexSnakeUI."]
);
...
expectSliceExcludes(
  "src/game.js",
  "window pointer alias slice",
  "window.addEventListener(\"pointermove\"",
  "Dom.playArea.addEventListener",
  ["HexSnakeState.", "HexSnakeUI."]
);

expectSliceExcludes(
  "src/game.js",
  "window keydown alias slice",
