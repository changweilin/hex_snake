...
1. 延續 Phase D service module migration：接續 `game.js` settings clamp / GM parameters slice，並維持 production `bundled-legacy-fallback`。
