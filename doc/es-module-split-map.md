...
1. 延續 Phase D service module migration：接續 `game.js` open game over character select slice，並維持 production `bundled-legacy-fallback`。
