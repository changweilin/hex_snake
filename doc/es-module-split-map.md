...
1. 延續 Phase D service module migration：接續 `game.js` random food generation helper slice，並維持 production `bundled-legacy-fallback`。
