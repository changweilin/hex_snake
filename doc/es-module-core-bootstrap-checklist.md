...
- Phase D 已開始 service module migration 小切片；`stats.js`、`about.js`、`network.js`、`audio.js`、`characters.js`、`replay.js` 與 `ai.js` 已集中 dependency aliases，後續可逐步替換成 explicit imports。
