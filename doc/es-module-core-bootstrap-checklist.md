...
- Phase D 已開始 service module migration 小切片；`stats.js`、`about.js`、`network.js`、`audio.js`、`characters.js` 與 `replay.js` 已集中 dependency aliases，後續可逐步替換成 explicit imports。
